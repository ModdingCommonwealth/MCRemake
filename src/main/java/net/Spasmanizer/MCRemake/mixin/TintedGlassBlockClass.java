...
@Mixin(targets = "net.minecraft.block.TintedGlassBlock")
public class TintedGlassBlockClass extends Block {
    public TintedGlassBlockClass(AbstractBlock.Settings settings) {
        super(settings);
